...
#==================================================================================
def game_complete():
    global run,sound_flag,exit_flag,health
    #sound_flag = False
    run = True
...
def game_death():
    global run,sound_flag,exit_flag
    #sound_flag = False
    run = True
...
#=================================================timer    
def hud():
    global timer_flag, frame_count,minutes,seconds
    font.init()
    ...
    output_string = "Time: {:02}:{:02}".format(minutes, seconds)
...
def flagpole(guy):
    x=0
    global flag, poleflag,running,timer_flag,triggerd_flag
...
def drawScene(picture,guy):
    global enemyList,coinList,character,triggerd_flag
    offset = findOffset(player)
...
def main_game():
    global sound_flag,coinDraw,points,health,triggerd_flag,enemyList,player,enemyPos0,enemyPos1,enemyPos2,enemyPos3,enemyPos4,movementList
    setting_rect = Rect(760,0,37,47)
    running = True
    myClock = time.Clock()
    while running:
...
def main_menu():
    global sound_flag,coinDraw,points,health,page,triggerd_flag,enemyList,enemyPos0,enemyPos1,enemyPos2,enemyPos3,enemyPos4,movementList
    running = True
    myClock = time.Clock()
